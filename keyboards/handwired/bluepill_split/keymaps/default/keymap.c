...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_NORMAL] = LAYOUT_bluepill_split( \
		/*	1			2			3			4			5			6			7			8			9 */		\
			KC_ESC, 	KC_MEDIA_PREV_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,KC_AUDIO_MUTE,KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP, 							\
			...
			KC_LCTL, 	KC_LGUI,	KC_LALT,      						KC_SPC,		MO(_ARROWS),KC_FN0),
	[_ARROWS] = LAYOUT_bluepill_split( \
		/*	1			2			3			4			5			6			7			8			9 */		\
			_______, 	_______, 	_______, 	_______, 	_______, 	_______, 	RESET, 							\
			_______, 	_______,  	_______,  	_______,  	_______,  	_______,  	_______, 								\
			_______, 	_______,   	_______,   	_______,   	_______,   	_______,   	_______, 								\
			_______, 	_______,   	_______,   	KC_UP,   	_______,   	_______,   	_______, 	_______,					\
